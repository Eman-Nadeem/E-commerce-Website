    ...
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        <div className="bg-gray-800 py-6 shadow sm:rounded-lg sm:px-10">
          ...
          <p className="mt-5 text-center text-sm text-gray-400">Already have an account? <Link to={'/login'} className="font-medium text-emerald-400 hover:text-emerald-300 ">Login here <ArrowRight className='inline h-4 w-4'/></Link></p>
        </div>
      </motion.div>
    </div>
  )
